...
### Sequences
plot_sequence_count_on_location = UNI.yes_no("Sequences: Plot Sequence count on location?")
...
def main():
    ...
    if plot_sequence_count_on_location:
        ...
        tags = config.get_all_tags("select-left", weight_change=.1)
        plot_sequence_landscape(tags, config)
